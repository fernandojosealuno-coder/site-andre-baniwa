        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 bg-[#FACC15]/20 backdrop-blur-sm px-4 py-2 rounded-full border border-[#FACC15]/30">
              ...
              <p className="text-[#FACC15] tracking-wide">
                Povo Baniwa • Sustentabilidade • Bem Viver
              </p>
            </div>

            <h1 className="text-5xl lg:text-7xl tracking-tight leading-tight">
              Uma voz indígena que conecta sabedoria ancestral com o futuro
              sustentável
            </h1>

            <p className="text-xl lg:text-2xl text-gray-200 leading-relaxed">
              André Fernando Baniwa - autor, empreendedor social e gestor
              ambiental comprometido com a transformação pela cultura indígena
            </p>
