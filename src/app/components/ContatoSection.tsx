...
export default function ContactSection() {
  return (
    <section className="py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-br from-[#064E3B] via-[#065F46] to-[#064E3B] text-white relative overflow-hidden">
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 left-0 w-72 sm:w-96 h-72 sm:h-96 bg-[#FACC15] rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-72 sm:w-96 h-72 sm:h-96 bg-[#065F46] rounded-full blur-3xl"></div>
      </div>

      <div className="max-w-5xl mx-auto relative z-10">
        <div className="text-center mb-10 sm:mb-16">
          <div className="inline-block bg-[#FACC15]/20 backdrop-blur-sm text-[#FACC15] px-4 sm:px-5 py-2 rounded-full mb-4 sm:mb-6 border border-[#FACC15]/30 text-sm sm:text-base">
            Contato
          </div>

          <h2 className="text-3xl sm:text-4xl lg:text-6xl mb-6 sm:mb-8 leading-tight">
            Quer adquirir o livro ou levar essa mensagem para mais pessoas?
          </h2>

          <p className="text-base sm:text-xl lg:text-2xl text-gray-200 mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12 sm:mb-16">
          ...
          >
            ...
            <div className="relative bg-[#FACC15] text-[#064E3B] px-6 sm:px-8 py-5 sm:py-6 rounded-2xl hover:bg-[#fcd34d] transition-all shadow-2xl flex items-center justify-center gap-4">
          ...
          >
            ...
            <div className="relative bg-white/10 backdrop-blur-sm border-2 border-white text-white px-6 sm:px-8 py-5 sm:py-6 rounded-2xl hover:bg-white/20 transition-all flex items-center justify-center gap-4">
              <img
        ...
        {/* CONTATO EXTRA */}
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-6 sm:p-10 mb-12 sm:mb-16 overflow-hidden">
        ...
        <div className="text-center">
          <div className="inline-block mb-6 sm:mb-8">
            <img
              src="/andre1.jpg"
              alt="André Baniwa"
              className="w-20 h-20 sm:w-24 sm:h-24 rounded-full border-4 border-[#FACC15]/30 shadow-2xl object-cover"
            />
          </div>
