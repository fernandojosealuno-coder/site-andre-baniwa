        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <p className="text-xl lg:text-2xl text-gray-200 leading-relaxed">
              Adquira agora o livro "BEM VIVER e viver bem" e descubra como a sabedoria ancestral pode guiar um futuro mais sustentável e harmonioso.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl mb-2">Entrega rápida para todo Brasil</h3>
                  <p className="text-gray-300">Receba em sua casa com total segurança</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Parte da renda apoia projetos comunitários</p>
                </div>
              </div>
            </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl p-10 shadow-2xl">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-200 text-lg mb-6">André Fernando Baniwa</p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mb-6">
                  ...
                  <p className="text-sm text-gray-300">Leitura transformadora e essencial</p>
                </div>
